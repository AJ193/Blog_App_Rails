...
RSpec.feature 'Logins', type: :feature do
  ...
  scenario('display email field') { expect(page).to have_field('user[email]') }
  scenario('displays password field') { expect(page).to have_field('user[password]') }
  scenario('displays email field') { expect(page).to have_button('Log in') }
